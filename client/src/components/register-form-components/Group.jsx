        ...
        <div className="col-span-1 relative  h-[4.3rem] flex flex-col gap-1">
          <div className="absolute top-0 left-0 w-full">
            ...
            <div className="mb-1">
              ...
              <select
                id="bookingStation"
                value={groupInfo.bookingStation}
                className={clsx(
                  ...
                  showRequired &&
                    required &&
                    !groupInfo.bookingStation &&
                    "ring-1 ring-primary-starberry-red"
                )}
                onChange={(e) => handleGroupInfo(e, "bookingStation")}
              >
                <option value="" selected>
            ...
            {showRequired &&
              !groupInfo.bookingStation && ( // Display error message condition
                <p className="text-primary-starberry-red leading-3 text-sm font-medium">
                  This Field is Required
                </p>
              )}
