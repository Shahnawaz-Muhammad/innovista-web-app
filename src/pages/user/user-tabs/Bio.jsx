...
const Bio = () => {
  return (
    <div className="bg-[#fffbf5] rounded-3xl flex flex-col md:flex-row justify-center">
      ...
      >
<button className="p-3 rounded-lg text-center text-4xl font-extrabold text-white bg-orange">Advance Booking</button>
      </div>
      ...
      <div className="w-full md:w-2/3 border-2 border-orange  ">
        <div className="p-3 grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="flex flex-row ">
              ...
              <h1 className="font-medium w-2/3">7188 E. Walnutwood St. Brooklyn, NY 11238</h1>
            </div>
            <div className="flex flex-row ">
